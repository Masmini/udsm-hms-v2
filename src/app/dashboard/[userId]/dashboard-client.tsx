...
export default function DashboardClient({ user }: { user: any }) {
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: <School />,
      color: '#f57c00',
      href: `/dashboard/${user.id}/programmes`,
    },
    {
      title: 'Projects',
      value: 0, // Will be calculated from hub memberships
      icon: <Assignment />,
      color: '#7b1fa2',
      href: `/dashboard/${user.id}/projects`,
    },
  ];
      ...
      <Paper sx={{ width: '100%' }}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <Tabs value={tabValue} onChange={handleTabChange}>
            ...
            <Tab label="Programmes" icon={<School />} />
          </Tabs>
        </Box>
        ...
        <TabPanel value={tabValue} index={1}>
          <Typography variant="h6" gutterBottom>
            My Hubs ({user.hubs.length})
          </Typography>
          <Grid container spacing={3}>
            {user.hubs.map((membership: any) => (
        ...
        <TabPanel value={tabValue} index={2}>
          ...
          <Grid container spacing={3}>
            {user.eventRegistrations.map((registration: any) => (
        ...
        <TabPanel value={tabValue} index={3}>
          ...
          <Grid container spacing={3}>
            {user.programmes.map((membership: any) => (
              <Grid item xs={12} sm={6} md={4} key={membership.id}>
                <Card>
